...
// TODO: Change to cl::alias when PR18649 is fixed.
static cl::opt<std::string, true> ObjectDirA("object-directory",
                                             cl::location(ObjectDir));
static cl::opt<std::string, true> ObjectDirB("object-file",
                                             cl::location(ObjectDir));
