...
namespace llvm {
  ...
  /// Apple Internal bitcode versioning
  // The patch version is manually bumped to indicate a bitcode change withing
  // a major revision, since we accept minor version mismatches, this is the way
  // to trigger an error.
  ...
  /// Apple Internal bitcode versioning, including manual patch version
