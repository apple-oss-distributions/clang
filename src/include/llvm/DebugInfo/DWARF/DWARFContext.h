...
public:
  ...
  virtual const DWARFSection& getAppleExternalTypesSection() = 0;
...
class DWARFContextInMemory : public DWARFContext {
  ...
  DWARFSection AppleExternalTypesSection;
...
public:
  ...
  const DWARFSection& getAppleExternalTypesSection() override { return AppleExternalTypesSection; }
