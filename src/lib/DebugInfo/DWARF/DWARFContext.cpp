...
void DWARFContext::dump(raw_ostream &OS, DIDumpType DumpType) {
  ...
  if (DumpType == DIDT_All || DumpType == DIDT_AppleExternalTypes)
    dumpAccelSection(OS, "apple_exttypes", getAppleExternalTypesSection(),
                     getStringSection(), isLittleEndian());
  ...
  for (const SectionRef &Section : Obj.sections()) {
    ...
    StringRef *SectionData =
        StringSwitch<StringRef *>(name)
            ...
            .Case("apple_exttypes", &AppleExternalTypesSection.Data)
    ...
    RelocAddrMap *Map = StringSwitch<RelocAddrMap*>(RelSecName)
        ...
        .Case("apple_exttypes", &AppleExternalTypesSection.Relocs)      
