...
public:
  ARM64InstPrinter(const MCAsmInfo &MAI,
...
protected:
  ...
  void printAlignedBranchTarget(const MCInst *MI,unsigned OpNum,raw_ostream &O);
...
public:
  ARM64AppleInstPrinter(const MCAsmInfo &MAI,
                        const MCInstrInfo &MII,
                        const MCRegisterInfo &MRI,
                        const MCSubtargetInfo &STI);
