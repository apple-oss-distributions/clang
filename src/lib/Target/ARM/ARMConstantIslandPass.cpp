...
void ARMConstantIslands::createNewWater(unsigned CPUserIndex,
  ...
  // Safe fix for <rdar://problem/11327101>. Problem is properly handled on
  // trunk. Move the split point back a bit to avoid looping if there isn't
  // room for all CPEs.
