...
void MCStreamer::EmitCFIRealignedOffset(int64_t Register, int64_t PreOffset,
                                        int64_t Align, int64_t PostOffset) {
  MCSymbol *Label = EmitCFICommon();
  MCCFIInstruction Instruction = MCCFIInstruction::createRealignedOffset(
      Label, Register, PreOffset, Align, PostOffset);
  MCDwarfFrameInfo *CurFrame = getCurrentDwarfFrameInfo();
  CurFrame->Instructions.push_back(Instruction);
}
