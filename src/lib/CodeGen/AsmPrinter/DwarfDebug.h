...
public:
  ...
  /// Set MInsn and extract the DIVariable from it.
...
public:
  ...
  void emitDebugLocEntry(const DebugLocEntry &Entry);
  /// \brief emit a single value for the debug loc section.
  void emitDebugLocValue(const DebugLocEntry::Value &Value);
  /// Emits an optimal (=sorted) sequence of DW_OP_pieces.
  void emitLocPieces(const DITypeIdentifierMap &Map,
