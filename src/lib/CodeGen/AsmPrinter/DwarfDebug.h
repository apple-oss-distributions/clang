...
class DwarfDebug : public AsmPrinterHandler {
  ...
  DIEDwarfAccelTable AccelNames;
  DIEDwarfAccelTable AccelObjC;
  DIEDwarfAccelTable AccelNamespace;
  DIEDwarfAccelTable AccelTypes;
  ModuleDwarfAccelTable AccelExternalTypes;
